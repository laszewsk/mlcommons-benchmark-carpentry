...
%
% THIS FILE IS FROZEN. GRAMMER AND SPELLING ERRORS ARE OK TO FIX. 
% IF CONTENT NEED TO CAHNAGE CONTACT GREGOR
%
...
Software Carpentry \cite{wilson2014software} was initially conceived to teach researchers in scientific fields fundamental computational and software development skills akin analogous to a hammer or level in a tool belt. Thus, non-computer scientists would improve the use and development of the software they need to conduct their own research while benefiting from targeted, short educational tutorials. 

Today, a global community effort has sprung up since 2018~\cite{softwarecarpentry2024} that provides a number of training materials and sessions to the scientific community to we can leverage in some extend. Recently, additional areas beyond software, such as data carpentry \cite{teal2015data,datacarpentry2025} 
% and library 
%  \cite{baker2016library,librarycarpentry2025}, have been added, but does not cover benchmarking sufficiently.
...
\begin{itemize}
 ...
 \item \textbf{Data Carpentry Efforts:}
  ...
  \item \textbf{Other Carpentry Efforts:}
   Library Carpentry provides lessons for information scientists, data stewards, and roles in library science, reusing some of the Software Carpentry topics adapted in a curation context. Additional lessons available include High-Performance Computing (HPC Carpentry) \cite{reid2025hpc,HPCcarpentry2025}, Cloud Computing, FAIR Data and Software, and Machine Learning for Domain Scientists.
...
\begin{comment}
\TODO{This section can likely not be added here as it is not general enough and may need to be moved elsewhere:}

On the software side, successful applications of benchmarks include the challenges that facilitated the development of image analysis software \TODO{cite ImageNet https://arxiv.org/abs/1409.0575}, protein structure prediction \TODO{cite CASP https://doi.org/10.1002/prot.340230303}, and single-cell analysis \TODO{cite Open Problems https://www.nature.com/articles/s41587-025-02694-w}.
An integral element of these successful projects is their focus on deliberating a comprehensive critical set of metrics that have high informative power with respect to the identified challenge.
In those cases of comparative software evaluation, it is often advisable to emphasise the separation of a hold-out test set and prevent any leakage of data from the public training set into the private test set, as modern high-parameter modelling approaches will exploit data leakage to artificially enhance performance metrics without real performance gains.
\end{comment}
