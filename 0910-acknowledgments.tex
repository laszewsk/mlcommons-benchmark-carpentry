...
We have used at one point ``ChatGPT'' to improve upon the grammar of selected section with the question: ``Improve the grammar of ...''. However we stopped that practice early on due to wrong corrections, and have used Grammarly throughout the paper.
