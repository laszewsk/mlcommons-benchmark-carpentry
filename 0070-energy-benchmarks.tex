...
\begin{figure}[tb]
    ...
    \caption{Energy Consumption for Training ChatGPT and Inferencing 1 Million Queries \TODO{(Data for GPT-5 is estimated, GPT-6 is projected.).} }
