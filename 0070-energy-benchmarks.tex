...
Energy consumption has quickly become a critical dimension of ML benchmarking. Training and inference with modern AI systems can require enormous computational resources. Training a single large-scale language model can consume megawatt-hours of electricity, often rivaling the annual energy consumption of households.  
...
\begin{table}[tb]
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{|l|c|l|r|r|r|}
            ...
            \hline
            \hline
            Jaguar\cite{BlandRogers2009-jaguar}   & 2009 & Multi-core CPU & 2.3   & 7  & 0.33 \\
            \hline
            Titan\cite{Bland2012-titan}    & 2012 & Hybrid CPU/GPU & 27    & 9  & 3.00 \\
            \hline
            Summit\cite{WombleShankar2019-summit}   & 2017 & Hybrid CPU/GPU & 200   & 13 & 15.38 \\
            \hline
            Frontier\cite{AtchleyZimmer2023-frontier} & 2021 & Hybrid CPU/GPU & 2000  & 29 & 68.97 \\
            \hline
        \end{tabular}
    }
    ...
    ~~~ Data derived from Papatheodore~\cite{papatheodore2022summitfrontier}.
    }
\end{table}
...
\begin{table*}[hptb]
  \centering
  \caption{Energy- or carbon-efficiency benchmarks (B) and tools (T) used in scientific-HPC research.}
